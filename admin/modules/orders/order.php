                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="d-flex gap-1">
                                        <a href="modules/orders/view_order.php" class="btn btn-sm btn-outline-primary">Xem</a>
                                        <a class="btn btn-sm btn-outline-secondary">Sửa</a>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex gap-1">
                                        <a class="btn btn-sm btn-outline-primary">Xem</a>
                                        <a class="btn btn-sm btn-outline-secondary">Sửa</a>
                                        <button class="btn btn-sm btn-outline-danger">Xóa</button>
                                    </td>
                                </tr>
